...
class IgnoreBenefitControllerISpec extends IntegrationBaseSpec {
  ...
  "Calling the 'ignore benefit' endpoint" should {
    ...
    "return error according to spec" when {
      ...
      val invalidFieldTypeError: MtdError = RuleIncorrectOrEmptyBodyError.copy(paths = Some(List("/ignoreBenefit")))
      ...
      "validation error" when {
        def validationErrorTest(requestNino: String, requestTaxYear: String, requestBenefitId: String, requestBody: JsValue,
        ...
        val input = Seq(
          ...
          ("AA123456A", "2019-20", "ABCDE12345FG", validRequestBodyJson, BAD_REQUEST, BenefitIdFormatError, None),
          ...
          ("AA123456A", getCurrentTaxYear, "78d9f015-a8b4-47a8-8bbc-c253a1e8057e", validRequestBodyJson, BAD_REQUEST, RuleTaxYearNotEndedError, None),
          ("AA123456A", "2019-20", "4557ecb5-fd32-48cc-81f5-e6acd1099f3c", emptyRequestBody, BAD_REQUEST, RuleIncorrectOrEmptyBodyError, None),
          ("AA123456A", "2019-20", "4557ecb5-fd32-48cc-81f5-e6acd1099f3c", invalidFieldTypeRequestBody, BAD_REQUEST, invalidFieldTypeError, Some("(invalid field type)"))
        )
