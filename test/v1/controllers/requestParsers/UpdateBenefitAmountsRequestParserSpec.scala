...
import v1.mocks.validators.MockUpdateBenefitAmountsValidator
...
class UpdateBenefitAmountsRequestParserSpec extends UnitSpec {
  ...
  private val updateBenefitAmountsRawData = UpdateBenefitAmountsRawData(
    nino = nino,
    taxYear = taxYear,
    benefitId = benefitId,
    body = validRawBody
  ...
  private val updateBenefitAmountsRequestBody = UpdateBenefitAmountsRequestBody(
    amount = 2050.45,
    taxPaid = Some(1095.55)
  )

  private val updateBenefitAmountsRequest = UpdateBenefitAmountsRequest(
    nino = Nino(nino),
    taxYear = taxYear,
    benefitId = benefitId,
  ...
  trait Test extends MockUpdateBenefitAmountsValidator {
    lazy val parser: UpdateBenefitAmountsRequestParser = new UpdateBenefitAmountsRequestParser(
